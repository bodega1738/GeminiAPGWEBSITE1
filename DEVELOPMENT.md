...
```bash
git remote add encore encore://maritime-crm-dashboard-rs82
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/maritime-crm-dashboard-rs82/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/maritime-crm-dashboard-rs82/settings/integrations/github)
